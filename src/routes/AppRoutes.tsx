...
const DailyMarketPrice = lazy(
  () => import("../pages/DailyMarketPrice/DailyMarketPrice"),
);
    ...
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route element={<MainLayout />}>
          ...
          {/* Daily Market Price */}
          <Route path="/daily-market-price" element={<DailyMarketPrice />} />

          <Route path="/wholesalers" element={<Wholesalers />} />

          <Route path="/wholesalers/:id" element={<WholesalerProfile />} />
